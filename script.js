...
function Handler(line){
    ...
    if(square1 == true && square2 == true && square3 == true && square4 == true && square5 == true && square6 == true && square7 == true && square8 == true && square9 == true){
        ...
        if(Math.max(red, green, yellow) == red){
            console.log("test1");
            first.innerHTML = "1st) Red - " + red;
            if(Math.max(green, yellow) == green){
                second.innerHTML = "2nd) Green - " + green;
                third.innerHTML = "3rd) Yellow - " + yellow;
            }
            else{
                second.innerHTML = "2nd) Yellow - " + yellow;
                third.innerHTML = "3rd) Green - " + green;
            }
        }
        else if(Math.max(red, green, yellow) == green){
            first.innerHTML = "1st) Green - " + green;
            if(Math.max(red, yellow) == red){
                second.innerHTML = "2nd) Red - " + red;
                third.innerHTML = "3rd) Yellow - " + yellow;
            }
            else{
                second.innerHTML = "2nd) Yellow - " + yellow;
                third.innerHTML = "3rd) Red - " + red;
            }
        }
        else{
            first.innerHTML = "1st) Yellow - " + yellow;
